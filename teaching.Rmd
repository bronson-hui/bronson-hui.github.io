...
* University of Maryland, College Park
  + Primary qualifying papers (full empirical study)
      + Cui, Jizhen
      + Woodward, Jill
      + Wu, Congyao
      + Simmons, Stefaine (completed)
      + Tytko, Tetiana (completed, see [Tytko et al., 2026](https://doi.org/10.1111/modl.70023))
      + Zhang, Danni
      
  + Secondary qualifying papers (research proposal)
      + Faqeeh, Samah
      + Hersh, Meghan (completed)
      + Jia, Ruirui (completed)
      + Ogawa, Sanshiro (completed)
      + Park, Sohye (completed)
      + Ryu, Hyeran 
      + Tytko, Tetiana (completed)
      + Wu, Zhiyi (completed; see [Wu & Toda Cosi, 2025](https://doi.org/10.1016/j.rmal.2025.100247))
  ...
  + Dissertations 
    ...
    + Jia, Ruirui 
    + Malone, Jon^1,2,4^ (co-chair with Kira Gor; completed; see [Malone, 2025](https://doi.org/10.64152/10125/73647); [Malone et al. 2025](https://doi.org/10.1111/lang.70007))
    + Park, Sohye (co-chair with Ekaterina Sudina)
    + Pulupa, Catherine (completed)
    + Tytko, Tetiana^4,5^
    
    *Notes*: Superscripts indicate that the student was a recipient of ^1^the *Language Learning* Dissertation Grant; ^2^the TIRF Doctoral Dissertation Grant; ^3^the TOEFL Grant for Doctoral Research in Language Assessment; ^4^the Duolingo Doctoral Dissertation Award; ^5^the NFMLTA/MLJ Dissertation Writing Support Grant
    
## Graduate-level courses

* University of Maryland, College Park

  + *SLAA 620 Second Language Research Methodologies* Fall, 2023; Fall 2024; Fall, 2025
  ...
  + *SLAA 750 Instructed Second Language Acquisition* Fall, 2022; Fall, 2023; Fall, 2025
